classdef platMetaBBOmodule_exp < handle
...
%--------------------------------------------------------------------------
    ...
    methods(Access = ?platMetaBBOGUI)
        %% Constructor
        function obj = platMetaBBOmodule_exp(platMetaBBOGUI)
            % The main grid
            obj.platMetaBBOGUI = platMetaBBOGUI;
            obj.app.maingrid = platMetaBBOGUI.APP(3,1,uigridlayout(obj.platMetaBBOGUI.app.maingrid,'RowHeight',{20,'1x'},'ColumnWidth',{'1.2x',1,'1x',1,'4x'},'Padding',[0 5 0 5],'RowSpacing',5,'ColumnSpacing',0,'BackgroundColor','w'));
            obj.app.label(1) = platMetaBBOGUI.APP(1,1,uilabel(obj.app.maingrid,'Text','Algorithm selection','HorizontalAlignment','center','FontSize',11,'FontColor',[.5 .5 .5]));
            obj.app.label(2) = platMetaBBOGUI.APP(1,3,uilabel(obj.app.maingrid,'Text','Parameter setting','HorizontalAlignment','center','FontSize',11,'FontColor',[.5 .5 .5]));
            obj.app.label(3) = platMetaBBOGUI.APP(1,5,uilabel(obj.app.maingrid,'Text','Result display','HorizontalAlignment','center','FontSize',11,'FontColor',[.5 .5 .5]));
            platMetaBBOGUI.APP([1 2],2,uipanel(obj.app.maingrid,'BackgroundColor',[.8 .8 .8]));
            platMetaBBOGUI.APP([1 2],4,uipanel(obj.app.maingrid,'BackgroundColor',[.8 .8 .8]));

            % The first panel
            obj.app.grid(1)    = platMetaBBOGUI.APP(2,1,uigridlayout(obj.app.maingrid,'RowHeight',{16,21,16,21,21,16,21,21,21,2,18,'1x',2,18,'1x',21,21,21},'ColumnWidth',{'1x','1.1x','1x'},'Padding',[8 5 8 0],'RowSpacing',3,'ColumnSpacing',5,'BackgroundColor','w'));
            [obj.app.stateA,obj.app.labelA] = platMetaBBOGUI.GenerateLabelButton(obj.app.grid(1),[0 1 0 1,zeros(1,13)],@obj.cb_filter);
            ...
            obj.app.dropA(2)   = platMetaBBOGUI.APP(14,2,uidropdown(obj.app.grid(1),'BackgroundColor','w','FontColor',[.9 .5 .2],'Items',{'All year'},'ValueChangedFcn',@(h,~)platMetaBBOGUI.UpdateAlgProListYear(obj.app.listA(2),h,obj.app.labelA(7),obj.platMetaBBOGUI.proList)));
            obj.app.labelA(8)  = platMetaBBOGUI.APP(16,[1 2],uilabel(obj.app.grid(1),'Text','Number of runs','FontColor',[.15 .6 .2],'FontWeight','bold','Tooltip','Number of runs for each algorithm on each problem'));
            obj.app.editA(1)   = platMetaBBOGUI.APP(16,3,uieditfield(obj.app.grid(1),'numeric','Value',31,'limits',[1 inf],'RoundFractionalValues','on','Tooltip','Number of runs for each algorithm on each problem'));
            obj.app.labelA(9)  = platMetaBBOGUI.APP(17,[1 2],uilabel(obj.app.grid(1),'Text','Number of results','FontColor',[.15 .6 .2],'FontWeight','bold','Tooltip','Number of populations saved in each run'));
            obj.app.editA(2)   = platMetaBBOGUI.APP(17,3,uieditfield(obj.app.grid(1),'numeric','Value',1,'limits',[1 inf],'RoundFractionalValues','on','Tooltip','Number of populations saved in each run'));
            tempGrid           = platMetaBBOGUI.APP(18,[1 3],uigridlayout(obj.app.grid(1),'RowHeight',{'1x'},'ColumnWidth',{'0.5x',20,'1x'},'Padding',[0 0 0 0],'RowSpacing',0,'ColumnSpacing',5,'BackgroundColor','w'));
            obj.app.labelA(10) = platMetaBBOGUI.APP(1,1,uilabel(tempGrid,'Text','File path','FontColor',[.15 .6 .2],'FontWeight','bold','Tooltip','File path for saving experimental settings'));
            obj.app.buttonA    = platMetaBBOGUI.APP(1,2,uibutton(tempGrid,'Text','...','BackgroundColor','w','ButtonpushedFcn',@obj.cb_filepath,'Tooltip','File path for saving experimental settings'));
            obj.app.editA(3)   = platMetaBBOGUI.APP(1,3,uieditfield(tempGrid,'Value',fullfile(cd,'Data','Setting.mat'),'HorizontalAlignment','right','Tooltip','File path for saving experimental settings'));
            
            % The second panel
            obj.app.listB   = uilist(obj.app.maingrid,obj.platMetaBBOGUI.app.figure,obj.platMetaBBOGUI.icon);
            obj.app.grid(2) = platMetaBBOGUI.APP(2,3,obj.app.listB.grid);
            obj.app.listA(1).ValueChangedFcn = @(~,~)platMetaBBOGUI.UpdateAlgProPara(obj.platMetaBBOGUI.app.figure,obj.app.listA(1),obj.app.listB,'BASEOPTIMIZER',2);
            obj.app.listA(2).ValueChangedFcn = @(~,~)platMetaBBOGUI.UpdateAlgProPara(obj.platMetaBBOGUI.app.figure,obj.app.listA(2),obj.app.listB,'PROBLEM',-2);

            % The third panel
            obj.app.grid(3)    = platMetaBBOGUI.APP(2,5,uigridlayout(obj.app.maingrid,'RowHeight',{30,'1x',30},'ColumnWidth',{230,'1x','1x',230},'Padding',[20 10 20 0],'ColumnSpacing',20,'BackgroundColor','w'));
            tempGrid           = platMetaBBOGUI.APP(1,[1 4],uigridlayout(obj.app.grid(3),'RowHeight',{1,'1x',1},'ColumnWidth',{18,24,24,24,24,24,'1x','1x','1x','1.2x'},'Padding',[5 5 5 5],'RowSpacing',0,'ColumnSpacing',8,'BackgroundColor',[.95 .95 1]));
            tempPanel          = platMetaBBOGUI.APP(2,1,uipanel(tempGrid,'BorderType','none','BackgroundColor',[.95 .95 1]));
            obj.app.toolC(1)   = uibutton(tempPanel,'Position',[-2.5 -2.5 24 24],'Text','','Icon',obj.platMetaBBOGUI.icon.savetable,'BackgroundColor',[.95 .95 1],'Tooltip','Save the table','ButtonpushedFcn',@obj.cb_save);
            tempPanel          = platMetaBBOGUI.APP(2,2,uipanel(tempGrid,'BorderType','none','BackgroundColor',[.95 .95 1]));
            obj.app.toolC(2)   = uibutton(tempPanel,'Position',[-2.5 -2.5 31 24],'Text','','Icon',obj.platMetaBBOGUI.icon.figure,'BackgroundColor',[.95 .95 1],'Tooltip','Display the results','ButtonpushedFcn',@obj.cb_tableDisplay);
            obj.app.toolC(3)   = platMetaBBOGUI.APP([1 3],3,uibutton(tempGrid,'state','Text','N','BackgroundColor',[.95 .95 1],'Tooltip','Show the population size','ValueChangedFcn',@obj.TableUpdateColumn));
            obj.app.toolC(4)   = platMetaBBOGUI.APP([1 3],4,uibutton(tempGrid,'state','Text','M','BackgroundColor',[.95 .95 1],'Value',1,'Tooltip','Show the number of objectives','ValueChangedFcn',@obj.TableUpdateColumn));
            obj.app.toolC(5)   = platMetaBBOGUI.APP([1 3],5,uibutton(tempGrid,'state','Text','D','BackgroundColor',[.95 .95 1],'Value',1,'Tooltip','Show the number of decision variables','ValueChangedFcn',@obj.TableUpdateColumn));
            obj.app.toolC(6)   = platMetaBBOGUI.APP([1 3],6,uibutton(tempGrid,'state','Text','FE','BackgroundColor',[.95 .95 1],'Tooltip','Show the maximum number of function evaluations','ValueChangedFcn',@obj.TableUpdateColumn));
            obj.app.dropC(1)   = platMetaBBOGUI.APP([1 3],7,uidropdown(tempGrid,'BackgroundColor',[.95 .95 1],'Tooltip','Show the specific metric values','Items',{},'Interruptible','off','BusyAction','cancel','ValueChangedFcn',@obj.TableUpdate));
            obj.app.dropC(2)   = platMetaBBOGUI.APP([1 3],8,uidropdown(tempGrid,'BackgroundColor',[.95 .95 1],'Tooltip','Show the mean value and standard deviation','Items',{'Mean','Mean (STD)','Median','Median (IQR)'},'ItemsData',1:4,'Value',2,'Interruptible','off','BusyAction','cancel','ValueChangedFcn',@obj.TableUpdate));
            obj.app.dropC(3)   = platMetaBBOGUI.APP([1 3],9,uidropdown(tempGrid,'BackgroundColor',[.95 .95 1],'Tooltip','Perform the Wilcoxon rank sum test','Items',{'none','Signed rank test','Rank sum test','Friedman test'},'ItemsData',1:4,'Value',3,'Interruptible','off','BusyAction','cancel','ValueChangedFcn',@obj.TableUpdate));
            obj.app.dropC(4)   = platMetaBBOGUI.APP([1 3],10,uidropdown(tempGrid,'BackgroundColor',[.95 .95 1],'Tooltip','Highlight the best result','Items',{'none','Highlight the best','Highlight all the bests'},'ItemsData',1:3,'Value',2,'Interruptible','off','BusyAction','cancel','ValueChangedFcn',@obj.TableUpdate));
            obj.app.table      = platMetaBBOGUI.APP(2,[1 4],uitable(obj.app.grid(3),'CellSelectionCallback',@obj.cb_tableSelect));
            obj.app.checkC     = platMetaBBOGUI.APP(3,1,uicheckbox(obj.app.grid(3),'Text','Parallel execution','Tooltip','Perform the experiment with multiple CPUs','Enable',~isempty(ver('parallel'))));
            obj.app.buttonC(1) = platMetaBBOGUI.APP(3,2,uibutton(obj.app.grid(3),'push','Text','Start','FontSize',16,'ButtonpushedFcn',@obj.cb_start));
            obj.app.buttonC(2) = platMetaBBOGUI.APP(3,3,uibutton(obj.app.grid(3),'push','Text','Stop','FontSize',16,'Enable','off','ButtonpushedFcn',@obj.cb_stop));
            obj.app.labelC     = platMetaBBOGUI.APP(3,4,uilabel(obj.app.grid(3),'Text','','HorizontalAlignment','right','VerticalAlignment','center'));
            obj.app.tablemenu  = uicontext(obj.platMetaBBOGUI.app.figure,110);
    ...
    methods(Access = private)
        ...
        function cb_filter(obj,~,~,index)
            ...
            func = platMetaBBOGUI.UpdateAlgProList(index,obj.app.stateA,obj.app.listA(1),obj.app.dropA(1),obj.app.labelA(5),obj.platMetaBBOGUI.algList,obj.app.listA(2),obj.app.dropA(2),obj.app.labelA(7),obj.platMetaBBOGUI.proList);
            % Update the list of metrics
            show = cellfun(@(s)func(s(2:end,1:end-2)),obj.platMetaBBOGUI.metList(:,1));
            obj.app.dropC(1).Items = ['Number of runs';'runtime';obj.platMetaBBOGUI.metList(show,2)];
            obj.TableUpdate();
        end
            ...
            if nargin < 4   % Load experimental settings
                ...
                if ischar(file)
                    try
                        ...
                        uialert(obj.platMetaBBOGUI.app.figure,sprintf('Fail to load the experimental settings from %s.',filename),'Error');
                        return;
                    end
                end
                ...
                try
                    ...
                    uialert(obj.platMetaBBOGUI.app.figure,sprintf('Fail to save the experimental settings to %s.',filename),'Error');
                    return;
                end
            end
            success = true;
        ...
        function cb_start(obj,~,~)
            ...
            elseif strcmp(obj.app.buttonC(1).Text,'Continue')
                ...
                try
                    ...
                    allList  = [obj.platMetaBBOGUI.algList;obj.platMetaBBOGUI.proList];
                    ...
                    for i = 1 : length(type)
                        [name,para] = platMetaBBOGUI.GetParameterSetting(obj.app.listB.items(i));
                        if type(i) > 0
                            if ~isParallel
                ...
                set([obj.platMetaBBOGUI.app.button,obj.app.stateA,obj.app.listA,obj.app.dropA,obj.app.editA,obj.app.buttonA],'Enable',false);
        ...
        function cb_stop(obj,~,~)
            set([obj.platMetaBBOGUI.app.button,obj.app.stateA,obj.app.listA,obj.app.dropA,obj.app.editA,obj.app.buttonA],'Enable',true);
        ...
        function TableUpdate(obj,~,~,proindex)
            ...
            if ~isempty(obj.data)
                ...
                allMet = [obj.platMetaBBOGUI.metList;{[0 1]},'Number of runs',{[]};{[1 0]},'runtime',{[]}];
        ...
        function cb_save(obj,~,~)
            if ~isempty(obj.app.table.Data)
                try
                    ...
                    uialert(obj.platMetaBBOGUI.app.figure,'Fail to save the table, please refer to the command window for details.','Error');
                    rethrow(err);
                end
            end
        end
        ...
        function cb_tableDisplay(obj,~,~)
            if ~isempty(obj.app.table.UserData)
                ...
                uialert(obj.platMetaBBOGUI.app.figure,'Please select at least one cell of metric value in the table.','Error');
            end
        end
