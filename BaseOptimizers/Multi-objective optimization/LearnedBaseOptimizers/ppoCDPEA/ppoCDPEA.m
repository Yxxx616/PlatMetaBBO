classdef ppoCDPEA < BASEOPTIMIZER
    properties
        curProblem
        consNum
        Population1
    ...
    methods
        ...
        function [reward, nextState, done]= update(baseOptimizer,action,Problem)
         %% Optimization
            ...
            [baseOptimizer.Population2,~] = EnvironmentalSelection_noCon([baseOptimizer.Population2,Offspring],Problem.N,baseOptimizer.alpha,gamma,baseOptimizer.para);
