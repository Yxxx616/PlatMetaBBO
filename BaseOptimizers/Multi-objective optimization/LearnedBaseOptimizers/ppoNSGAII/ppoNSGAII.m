classdef ppoNSGAII < BASEOPTIMIZER
...
% Nondominated sorting genetic algorithm II
    ...
    methods
        ...
        function [reward, nextState, done, bestPop] = update(baseOptimizer,action,Problem)
            ...
            [baseOptimizer.Population,baseOptimizer.FrontNo,baseOptimizer.CrowdDis] = EnvironmentalSelection([baseOptimizer.Population,Offspring],Problem.N,action);
